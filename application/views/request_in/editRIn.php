  ...
  <div class="">
    ...
    <div class="row">
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          <div class="x_title">
            <h2>Edit Request In</h2>
            <div class="clearfix"></div>
          </div>
          <div class="x_content">
            <?php echo $this->session->flashdata('error');?>
            <form class="form-horizontal form-label-left" enctype="multipart/form-data" method="POST" action="<?php echo site_url('requestin/actEdit')?>" id="form_product">
              ...
              <div class="item form-group <?= form_error('request_in') ? 'has-error': ''?>">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="request_in">Product <span class="required">*</span>
                </label>
                <div class="col-md-3 col-sm-3 col-xs-12">
                  <select class="form-control select2" id="request_in" name="request_in" style="width: 100%">
                    <option value="">-- Choose Product --</option>
                    <?php foreach ($product as $value): ?>
                      <option value="<?= $value->tbl_barang_id ?>"><?= $value->name ?></option>
                    <?php endforeach; ?>
                  </select>
                  <?= form_error('request_in') ?>
                </div>
              </div>
              ...
              <input type="hidden" class="form-control col-md-3 col-xs-12" id="request_in_id" name="request_in_id" value="<?= $request_in_id ?>" readonly>
              <div class="ln_solid"></div>
              <div class="form-group">
                <div class="col-md-6 col-md-offset-3">
                  <a href="<?php echo site_url('requestin') ?>" class="btn btn-default">Back</a>
